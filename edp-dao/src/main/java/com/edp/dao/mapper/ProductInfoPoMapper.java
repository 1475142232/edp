...
public interface ProductInfoPoMapper {
	...
	List<ProductInfoPo> getAllProduct(@Param("team_id") String teamId, @Param("user_id")Integer id);

	Integer addUTPId( @Param("user_id")Integer userId, @Param("team_id")String teamId, @Param("product_id")String id,@Param("role_type")Integer role_type);

	Integer delUserIdByProductId(@Param("product_id")String id);
